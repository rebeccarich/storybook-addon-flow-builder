...
AI driven user flow creation. You type a plain-English description of a user flow or requirement and the AI will read your existing Storybook component library, apply UX reasoning to decide which components to use and produce an annotated interactive flow.
