...
export const Tab: React.FC<TabProps> = ({ active }) => {
  ...
  const config = useParameter<string>(KEY, 'fallback value of config from parameter');
    ...
    <TabWrapper>
      <TabInner>
        ...
        <p>
          ...
          to match the look and feel of Storybook, for example the <code>&lt;Code /&gt;</code> component below. Or build
